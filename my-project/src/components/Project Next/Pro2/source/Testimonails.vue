<script setup>
  ...
  function startAutoSlide() {
    setInterval(() => {
      currentSlide.value = (currentSlide.value + 1) % testimonialsData.cartInfo.length;
    }, 4000); 
  }
...
<template>
  ...
  <div class="w-full bg-gray-100">
    <div class="relative w-[600px] h-[70vh] m-auto overflow-hidden">
    <!-- Slider Container -->
    <div
    ...
    >
      ...
      >
        <div class="w-[450px] py-5 flex flex-col justify-between shadow-md bg-slate-100 px-10 rounded-md">
          ...
          <div class="flex justify-center pt-4">
            <img class="rounded-full w-24" :src="cart.cartImg" alt="" />
          </div>
